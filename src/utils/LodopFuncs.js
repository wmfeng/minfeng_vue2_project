...
export function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<br><font color='#FF00FF' style='position: absolute;z-index: 10000001;background: yellow;width: 100%;line-height: 30px; top:0;'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='/Clodop/CLodop_Setup_for_Win64NT_3.041Extend.exe' target='_blank' download >执行安装</a>,安装后请刷新页面。</font>";/*CLodop_Setup_for_Win32NT.exe*/
